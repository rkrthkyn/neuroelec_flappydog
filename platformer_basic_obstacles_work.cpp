...
int main() {
	...
	/*
	obstacles hurdle1_1({ 50, 300 });
	obstacles hurdle1_2({ 50, windowDimensionY-300-passageWidth});
	hurdle1_1.setPos({ obstPos,0 });
	hurdle1_2.setPos({ obstPos, 300+passageWidth });
	...
	*/
	...
	//----------------------------------------------------------
	/* Everything here needs a fix:
		1. Obstacle position to be updated dynamically, because hurdlen_2 is not the same starting point always.
		2. Look at other ways to define hurdlen_2ht
		3. Check iterators, etc.
	*/
